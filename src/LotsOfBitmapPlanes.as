package 
{
	...
	public class LotsOfBitmapPlanes extends Sprite
	{
		//-----------------------------------------------------------------
		// Away3D4 Vars
		...
		public function LotsOfBitmapPlanes()
		{
		...
		private function setupMaterials():void
		{
			...
			sourceClip = new Sprite();
			sourceClip.graphics.beginFill(0xFFFFFF);
			sourceClip.graphics.drawRect(0, 0, 1024, 1024);
			sourceClip.addChild(new BouncingBall());
			bmd = new BitmapData(sourceClip.width, sourceClip.height, false, 0);
			bmd.draw(sourceClip);
		...
		private function setupPrimitivesAndModels():void
		{
			...
			{
				var plane:Plane= new Plane(planeMaterial, 1024, 1024, 1, 1);
